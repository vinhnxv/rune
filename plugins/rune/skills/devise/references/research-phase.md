...
All research agents (repo-surveyor, echo-reader, git-miner, wiring-cartographer, activation-pathfinder, practice-seeker, lore-scholarr, flow-seer) follow this communication protocol:
...
const externalFiles = []
for (const filename of ["best-practices.md", "framework-docs.md"]) {
  try {
