...
> **Summon throttle**: At most 5 forge agents run concurrently regardless of mode. When total agents exceed 5, remaining agents are queued and spawned as earlier agents complete. This prevents resource exhaustion and context window pressure on the team lead.
