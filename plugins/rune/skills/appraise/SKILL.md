...
> **Utility Crew** (Phase 2.5-2.8): When `utility_crew.enabled` in talisman, context-scribe composes per-Ash context packs and prompt-warden validates them before Phase 3 spawning. See [utility-crew](../utility-crew/SKILL.md).
