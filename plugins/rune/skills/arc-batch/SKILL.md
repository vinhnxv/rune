...
Executes `/rune:arc` across multiple plan files sequentially. Each arc run completes the full 28-phase pipeline (forge through merge) before the next plan starts.
