...
Validates VSM coverage before proceeding to implementation. See [verification-gate.md](references/verification-gate.md) for the full algorithm and output formats.
...
// See references/backend-impact.md for full decision tree
