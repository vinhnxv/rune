...
```
SEC (Ward Sentinel) > BACK (Forge Warden) > VEIL (Veil Piercer) > DOUBT (Doubt Seer) > FLOW (Flow Integrity Tracer) > DOC (Knowledge Keeper) > QUAL (Pattern Weaver) > FRONT (Glyph Scribe)
```
