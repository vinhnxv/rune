...
function buildCompletionRecord(checkpoint, newStatus, content) {
  ...
  // browser_test*, semantic_verification, task_decomposition, test_coverage_critique,
  // release_quality_check, goldmask_verification, goldmask_correlation, bot_review_wait,
