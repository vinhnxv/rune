...
Arc phase summaries are written by the orchestrator at the end of each **phase group** to compress completed phase history before entering the next group. This prevents inline phase history from accumulating across 45 phases and exhausting context.
