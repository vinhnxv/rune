...
This is the **Rune plugin** — the detailed component reference for the Rune multi-agent orchestration system. It documents all 151 agents, 67 skills, 16 commands, 5 MCP servers, and the hook infrastructure that powers Rune's workflows.
