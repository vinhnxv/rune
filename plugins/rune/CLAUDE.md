...
- [Agent registry](references/agent-registry.md) — 129 agent definitions (86 CORE in agents/ + 43 EXTENDED in registry/, 3 shared). 12 stack specialist reviewers are prompt templates, not registered agents
