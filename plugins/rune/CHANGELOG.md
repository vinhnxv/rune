...
- **talisman**: `design_sync.appraise_fidelity_review` and `design_sync.inspect_design_dimension` review gates (default: true when `design_sync.enabled`). Zero overhead for projects without design artifacts.
