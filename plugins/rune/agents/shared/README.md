...
|------|-------|----------------------------------------|----------------------------------------------|---------|
| `communication-protocol.md` | ~36 | rune-smith, trial-forger, mend-fixer, gap-fixer, verdict-binder, grace-warden, sight-oracle, vigil-keeper, ruin-prophet (inspect mode) | — | Seal format, shutdown handling, SendMessage conventions, exit conditions |
| `quality-gate-template.md` | ~37 | rune-smith, trial-forger, grace-warden, sight-oracle, vigil-keeper, ruin-prophet (inspect mode) | ward-sentinel, knowledge-keeper (via devise/arc orchestrators) | Confidence calibration, Inner Flame supplementary, self-review pass |
...
| `truthbinding-protocol.md` | ~96 | rune-smith, trial-forger, mend-fixer, gap-fixer, ward-sentinel, pattern-seer, flaw-hunter, lore-analyst, goldmask-coordinator, grace-warden, sight-oracle, vigil-keeper, ruin-prophet (inspect mode) | — | ANCHOR/RE-ANCHOR Truthbinding security framing, untrusted content handling, injection defense |
| `finding-format-template.md` | ~62 | ward-sentinel, pattern-seer, flaw-hunter, grace-warden, knowledge-keeper | — | Standardized finding output format, severity levels, evidence requirements |
...
| `phase-inspect.md` | ~120 | grace-warden, sight-oracle, vigil-keeper, ruin-prophet (inspect mode) | Inspect investigation patterns, requirement matrix, gap categories |
