...
to `/rune:arc` for the full 16-phase pipeline (forge → plan_review → work → inspect → code_review → mend → test → ship → merge; v3.0.0-alpha.7 Day 6 absorbed gap_analysis + gap_remediation into inspect).
