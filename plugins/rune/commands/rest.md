...
const RUNE_TEAM_PATTERN = /^(rune-work|rune-review|rune-mend|rune-audit|rune-plan|rune-forge|rune-inspect|rune-goldmask|rune-brainstorm|rune-debug|rune-design-sync|rune-custom|arc-forge|arc-plan-review|arc-review|arc-audit|arc-work|arc-mend|arc-verify)-/
