...
> **Note (v1.120.2+):** Arc now has 43 phases (added Design Extraction, Design Prototype, Design Verification, Design Iteration, UX Verification, and Pre-Ship Validation).
