...
`/rune:arc` chạy review → mend → verify-mend tự động trong pipeline 43 phase. Dùng appraise/mend riêng khi bạn muốn review có mục tiêu mà không cần full pipeline.
