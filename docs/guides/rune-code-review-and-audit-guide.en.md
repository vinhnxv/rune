...
`/rune:arc` runs review → mend → verify-mend automatically as part of its 29-phase pipeline. Use standalone appraise/mend when you want targeted review without the full pipeline.
