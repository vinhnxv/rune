...
> **Lưu ý (v1.120.2+):** Arc pipeline hiện có 40 phase (tăng từ 23), thêm Design Extraction, Design Prototype, Design Verification, Design Iteration, UX Verification, và Pre-Ship Validation.
