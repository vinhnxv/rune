...
4. **Mỗi plan con** chạy pipeline arc 43 phase đầy đủ (forge → work → review → mend → test → ship).
...
3. Pipeline arc 43 phase đầy đủ chạy (forge → work → review → mend → test → ship → merge).
