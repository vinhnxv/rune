...
> **Lưu ý (v1.120.2+):** Arc hiện có 40 phase (thêm Design Extraction, Design Prototype, Design Verification, Design Iteration, UX Verification, và Pre-Ship Validation).
